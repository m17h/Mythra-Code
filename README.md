...
Selected Mythra Code skills and custom sub-agents are bridged to Claude through a generated local plugin directory. Model and reasoning-effort choices are sent as real CLI flags per turn.
