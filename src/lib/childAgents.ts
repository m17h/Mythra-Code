...
export function childAgentTargetIssue(
  ...
  if (target.provider === "lmstudio" && !model) {
    return "LM Studio needs a model selected from its local catalog.";
  }
  ...
  if (target.provider === "lmstudio" && !readiness.lmStudioReady) return "Start LM Studio and load a model first.";
...
export const SUGGESTED_CHILD_AGENT_TARGETS: Array<Omit<ChildAgentTarget, "enabled">> = [
  ...
  { id: "lmstudio", provider: "lmstudio", model: "", label: "LM Studio", description: "A local model served by LM Studio on this PC.", reasoningMode: "inherit", reasoningEffort: "medium", reasoningMaxEffort: "high" },
];
