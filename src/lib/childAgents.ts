...
/** Runtime readiness of every provider Mythra Code can start a child on. */
...
/** The delegation policy a root thread carries between atomic turn-boundary edits. */
export interface ChildAgentPolicy {
  /**
   * Identity of the backend bridge session. Generated by Mythra Code rather than
